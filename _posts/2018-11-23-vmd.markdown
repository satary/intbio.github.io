...
One convenient way is to compile vmd against the conda provided python and other libraries. The example below uses system compiler and framewors except for python. This makes it easy to install python packages later through conda and they will be available in vmd.
